...
if req == 'Chaves OK':
    ...
    assinaturaCriptografado = critogrtafiaAES(assinatura, senhaCriptografia)
    mClientSocket.send(assinaturaCriptografado.encode())
...
if req2 == str(chaveCompartilhada):
    ...
    # Recebe assinatura
    data1 = mClientSocket.recv(2048)
    reqassinatura1 = data1.decode()
    asinaturaDescriptografado1 = descriptografiaAES(reqassinatura1, senhaCriptografia)
    # Verifica assinatura
    if str(asinaturaDescriptografado1) != str(assinatura):
